...
<head>
    ...
    <title>Web Pengabsenan</title>
</head>
<body>  
<div class="text-center mt-5">
    <h1>Absen para santri</h1>
    <div class="text-center">
    <h4>Absen dulu gak sih....</h4>
                ...
                @foreach($todos as $todo)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <div class="badge bg-warning">Ghaib</div>
                            @endif
                        </td>
                        <td>
...
<h3 align='center'>Jujurlah dalam mengisi!!</h3>
